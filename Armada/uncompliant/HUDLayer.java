...
*/
public class HUDLayer extends ViewLayer {
	...
	*/
	public HUDController(GameController gc) {
	    gameController = gc;
		huds = new ArrayList<HUD>();
		mode = new ModeHUD(gc, 1);//0=default, 1 = top left, 2 = top right, 3 = bot left, 4 = bot right
		stat = new StatHUD(gc, 2);
		turn = new TurnHUD(gc);
		map = new MapHUD(gc,4);
		items= new ItemListHUD(gc, 6, this);
